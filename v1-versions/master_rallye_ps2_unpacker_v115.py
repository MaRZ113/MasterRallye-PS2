...
# Clean bucket subclasses for 425425**, now including promoted stable branches from 0D@552
BUCKET_REGISTRY = [
    {
    ...
    # promoted stable branches from quarantine bucket none || 0D@552
    {
...
def main():
    ap = argparse.ArgumentParser(description='BX v115 promoted 425425 bucket framework extractor')
    sub = ap.add_subparsers(dest='cmd', required=True)

    p = sub.add_parser('extract-425425-framework-promoted')
    ...
    ns = ap.parse_args()
    if ns.cmd != 'extract-425425-framework-promoted':
        raise SystemExit(1)
    ...
    summary = []
    summary.append('BX v115 promoted 425425 bucket framework extractor')
    summary.append('=================================================')
