...
# Promoted clean subclasses for 425425**, including 0B@-295 split
BUCKET_REGISTRY = [
    {
...
def main():
    ap = argparse.ArgumentParser(description='BX v119 promoted prevlink 425425 framework extractor')
    sub = ap.add_subparsers(dest='cmd', required=True)

    p = sub.add_parser('extract-425425-framework-promoted-prevlink')
    ...
    ns = ap.parse_args()
    if ns.cmd != 'extract-425425-framework-promoted-prevlink':
        raise SystemExit(1)
    ...
    summary = []
    summary.append('BX v119 promoted prevlink 425425 framework extractor')
    summary.append('===================================================')
