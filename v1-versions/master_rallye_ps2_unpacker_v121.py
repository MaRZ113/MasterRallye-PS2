...
# Clean subclasses for 425425**, now including promoted 0D@1188 branches.
BUCKET_REGISTRY = [
    {
...
def main():
    ap = argparse.ArgumentParser(description='BX v121 promoted tailed 1188 framework extractor')
    sub = ap.add_subparsers(dest='cmd', required=True)

    p = sub.add_parser('extract-425425-framework-promoted-1188')
    ...
    ns = ap.parse_args()
    if ns.cmd != 'extract-425425-framework-promoted-1188':
        raise SystemExit(1)
    ...
    summary = []
    summary.append('BX v121 promoted tailed 1188 framework extractor')
    summary.append('==============================================')
