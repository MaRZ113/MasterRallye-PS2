...
def cmd_coverage(args: argparse.Namespace) -> None:
    ...
    summary = []
    summary.append('MRPS2 v145 coverage')
    summary.append('===================')
...
def build_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(description='Master Rallye PS2 TNG.000 rulepack-driven CLI v145')
    ...
    def add_common(p):
        ...
        p.add_argument('--sig7', type=str, default='0000010c43fc6f')
